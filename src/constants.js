// PRICE PER SLOT (per hour, per court). Edit this to match your real rate.
export const PRICE_PER_SLOT = 150; // pesos


export const EMAILJS_PUBLIC_KEY = "pJGKslpwfAaGC9ZpV";
